...
| [`power-of-ten`](plugins/power-of-ten/README.md)                                                                             | Apply all ten language-agnostic rules to every coding task. Inspect the code needed for the task, improve encountered violations without widening i... |
