...
Subagents may communicate with each other, but no agent may communicate with a person. Keep the design and findings local. Never send, post, comment, review, or mutate an external system.
