...
Use for read-only questions about behavior, history, architecture, or a choice between alternatives.

1. Define the exact question and the evidence that could answer it.
2. Read repository instructions and map the relevant source with available code-search and explanation skills.
