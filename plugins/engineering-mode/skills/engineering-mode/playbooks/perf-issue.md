...
1. Capture a realistic baseline on the matching user surface. Record the workload, environment, sample count, and noise.
...
6. Compare distributions or repeated samples. A wrong-surface or inconclusive result is not a pass.
