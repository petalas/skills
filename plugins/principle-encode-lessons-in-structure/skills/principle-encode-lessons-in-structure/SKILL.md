...
- **Route to the right layer.** One-off -> the repository's documented learning-note location, or a local note chosen from repository instructions. Recurring fix -> skill or lint rule. Systemic issue -> principle.
