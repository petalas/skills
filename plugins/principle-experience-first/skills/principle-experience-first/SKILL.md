...
The user is whoever consumes the work. For a UI that is the end user. For a library or an internal API it is the developer who imports it. The engineer who maintains the code next is a user too. Weigh their experience the same way, and explain impact from their seat.
